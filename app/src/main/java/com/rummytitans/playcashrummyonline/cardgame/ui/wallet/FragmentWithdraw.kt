...
import com.rummytitans.playcashrummyonline.cardgame.databinding.FragmentWithdrawRummyBinding
...
import com.rummytitans.playcashrummyonline.cardgame.ui.wallet.viewmodel.WithdrawViewModel
import com.rummytitans.playcashrummyonline.cardgame.ui.wallet.withdrawal.WithdrawalDoneActivity
...
import com.rummytitans.playcashrummyonline.cardgame.ui.wallet.WithdrawalTdsAdapter
import com.rummytitans.playcashrummyonline.cardgame.ui.wallet.WithdrawalMethodsAdapter
...
class FragmentWithdraw : BaseFragment(), MainNavigationFragment,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.withdrawalModel.observe(viewLifecycleOwner) {
            val filter=
                com.rummytitans.playcashrummyonline.cardgame.widget.inputFilter.InputRegexFilter("^[1-9][0-9]*")
            ...
            binding.edtWithdrawAmount.filters = arrayOf(filter,
                com.rummytitans.playcashrummyonline.cardgame.widget.inputFilter.MaxAmountRegexFilter(
                    textLength
                ) {
                    kotlin.runCatching {
                        val maxAmount =
