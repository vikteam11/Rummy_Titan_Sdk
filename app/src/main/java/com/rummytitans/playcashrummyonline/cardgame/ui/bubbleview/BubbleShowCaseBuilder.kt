package com.rummytitans.playcashrummyonline.cardgame.bubbleview
...
class BubbleShowCaseBuilder {
    ...
    internal var mSequenceShowCaseListener: BubbleShowCase.SequenceShowCaseListener? = null
    private var onSkipInterface: BubbleShowCaseSequence.OnSkipInterface? = null
    ...
    private var mBubbleShowCase:BubbleShowCase?=null

    companion object {
        const val home_profile = "home_profile"
        const val Favourite_Home = "Favourite_Home"
        const val Match_Selection_Home = "Match_Selection_Home"
        const val Live_Match_Inning_tab = "Live_Match_Inning_tab"
        const val All_Contests_Match_Section = "All_Contests_Match_Section"
        const val League_Info_Match_Section = "League_Info_Match_Section"
        const val Create_Team_Match_Section = "Create_Team_Match_Section"
        const val Withdrawal_Wallet_Section= "Withdrawal_Wallet_Section"

        const val Levels_Profile = "Levels_Profile"
        const val Kyc_Header_Profile = "Kyc_Header_Profile"
        const val Stats_Profile = "Stats_Profile"
        const val Match_Screen_Live_Fantasy = "Match_Screen_Live_Fantasy"
    }
    ...
    fun setHideSkipbutton(btnStatus: Boolean): BubbleShowCaseBuilder {
     ...
     */
    internal fun sequenceListener(sequenceShowCaseListener: BubbleShowCase.SequenceShowCaseListener): BubbleShowCaseBuilder {
    ...
    fun setListner(onSkipInterface: BubbleShowCaseSequence.OnSkipInterface?): BubbleShowCaseBuilder {
    ...
    fun show(): BubbleShowCase {
        ...
        mBubbleShowCase = bubbleShowCase
        bubbleShowCase.setlistner(onSkipInterface)
        bubbleShowCase.setHideSkipbutton(hideSkipbutton)
        if (mTargetView != null) {
