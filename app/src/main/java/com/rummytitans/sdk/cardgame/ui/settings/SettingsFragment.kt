...
import com.rummytitans.sdk.cardgame.databinding.AlertLanguageChangeRummyBinding
import com.rummytitans.sdk.cardgame.databinding.DialogAlertNotificationRummyBinding
import com.rummytitans.sdk.cardgame.databinding.FragmentMySettingsRummyBinding
...
import com.rummytitans.sdk.cardgame.ui.settings.adapter.ColorListAdapter
import com.rummytitans.sdk.cardgame.ui.settings.adapter.MatchTimeTypeAdapter
import com.rummytitans.sdk.cardgame.ui.settings.adapter.NotificationAdapter
...
class SettingsFragment : BaseFragment(),
    BaseNavigator, SettingFragmentNavigator,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.apply {
            isHindiLanguage.set(LocaleHelper.getLanguage(context) == getString(R.string.hindi_code))
    ...
    fun showLanguageDialog(state: Boolean) {
        ...
        alertDialog?.btnCancel?.setOnClickListener {
            binding.languageType.isChecked =
                LocaleHelper.getLanguage(context) == getString(R.string.hindi_code)
            alertDialog?.dismiss()
        }
    }
    ...
    override fun onResume() {
        ...
        if (!isNotifcationsSatusUpdate()) {
            ...
            if ((context as? MainApplication)?.isNotificationApiUpdateRequire == true) {
                viewModel.fetchTopicsAndSubscribe()
                (context as? MainApplication)?.isNotificationApiUpdateRequire = false
            }
        }
    }
