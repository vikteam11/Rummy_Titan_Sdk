package com.rummytitans.sdk.cardgame.utils.utilClasses
...
fun createReferLink(referCode: String?, success: (link: String) -> Unit = {}) {
   /* val builder = FirebaseDynamicLinks.getInstance().createDynamicLink()
        ...
        .setAndroidParameters(
            DynamicLink.AndroidParameters.Builder("com.rummytitans.sdk.cardgame")
                .setFallbackUrl(Uri.parse("https://play.google.com/store/apps/details?id=com.rummytitans.sdk.cardgame")).build()
        ).setIosParameters(
            DynamicLink.IosParameters.Builder("com.rummytitans.sdk.cardgame").setAppStoreId("1221862854").build()
        )
