...
import com.rummytitans.sdk.cardgame.databinding.RummyCropImageActivityBinding;
...
public class CropImageActivity extends AppCompatActivity
  ...
  private RummyCropImageActivityBinding binding;

  @Override
  @SuppressLint("NewApi")
  public void onCreate(Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
    binding = DataBindingUtil.setContentView(this, R.layout.rummy_crop_image_activity);
